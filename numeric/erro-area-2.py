...
for b in B:
	...
	if count == 2: 
		plt.plot(di,pe[(count-1)*1000:count*1000], lw=3, label='B=total')
		plt.plot(di,costas[(count-1)*1000:count*1000], lw=2, label='B=costas')
		plt.plot(di,frente[(count-1)*1000:count*1000], lw=2, label='B=frente')
