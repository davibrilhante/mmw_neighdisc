						...
						do
							...
							do
								...
								do
									...
									qsub -e /homesim/dbrilhante/log/mmw/log-$DATE -o /homesim/dbrilhante/outputs/$PREFIX-$DATE/$nnodes-$nbeams-$meand-$meana-$runs -V -b y -cwd -shell n  $SCRIPT_COMMAND $nnodes $nbeams $meand $meana $RELIEF $runs
